    ...
    module Categories
      RSpec.describe CategoryGuestSerializer, type: :model do
        ...
        it 'inherits from CategoryBaseSerializer class' do
          expect(CategoryGuestSerializer).to be < CategoryBaseSerializer
        end
        ...
        describe '#faq' do
          ...
          it 'calls Tickets::TicketGuestSerializer for :faq association' do
            expect(QuestionTickets::QuestionTicketGuestSerializer).to receive(:new).exactly(5).times.and_call_original
